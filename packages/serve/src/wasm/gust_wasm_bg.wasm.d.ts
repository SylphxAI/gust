...
export const format_traceparent: (a: number, b: number, c: number, d: number, e: number) => [number, number];
...
export const validate_number: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
export const validate_string: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
