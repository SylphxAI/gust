...
import type { ServerResponse, Handler } from '@aspect/serve-core'
import { serverError } from '@aspect/serve-core'
...
const sendResponse = (
  ...
  if (response.body !== null) {
    const bodyLen = typeof response.body === 'string'
    ...
    stream.pushStream(
      ...
      (err, pushStream) => {
        ...
        const responseHeaders: Record<string, string | number> = {
          ...
          [HTTP2_HEADER_CONTENT_LENGTH]: typeof content === 'string'
