...
describe('HTTP/2', () => {
  describe('preloadHint', () => {
    ...
    it('should include crossorigin attribute', () => {
      const hint = preloadHint([
        { path: '/font.woff2', as: 'font', crossorigin: true },
      ])
    ...
    it('should not include crossorigin when false', () => {
      const hint = preloadHint([
        { path: '/script.js', as: 'script', crossorigin: false },
      ])
    ...
    it('should handle paths with special characters', () => {
      const hint = preloadHint([
        { path: '/path/to/file.js?v=123', as: 'script' },
      ])
    ...
    it('should handle absolute URLs', () => {
      const hint = preloadHint([
        { path: 'https://cdn.example.com/script.js', as: 'script' },
      ])
  ...
  describe('preload helpers', () => {
    ...
    it('should work with preloadHint', () => {
      const hint = preloadHint([
        preload.script('/app.js'),
        preload.style('/styles.css'),
  ...
  describe('edge cases', () => {
    ...
    it('should handle path with spaces', () => {
      const hint = preloadHint([
        { path: '/path/with spaces/file.js', as: 'script' },
      ])
