 ...
 */
export function validate_number(value: number, min: number | null | undefined, max: number | null | undefined, is_integer: boolean): WasmValidationResult;

/**
 * Validate a string value
 */
export function validate_string(value: string, min_length?: number | null, max_length?: number | null, format?: string | null): WasmValidationResult;
...
export interface InitOutput {
  ...
  readonly format_traceparent: (a: number, b: number, c: number, d: number, e: number) => [number, number];
  ...
  readonly validate_number: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly validate_string: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
