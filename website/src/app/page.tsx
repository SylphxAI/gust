		...
		<main className="flex min-h-screen flex-col">
			...
			<section className="flex flex-1 flex-col items-center justify-center px-4 py-16 text-center">
				...
				<p className="mb-8 max-w-2xl text-fd-muted-foreground">
					For Bun and Node.js. Native Rust acceleration, portable apps for serverless/edge, and
				...
				<div className="mt-8 rounded-lg border bg-fd-card p-4">
					<code className="text-sm text-fd-muted-foreground">bun add @sylphx/gust</code>
				</div>
			</section>
			...
			<section className="border-t bg-fd-secondary/30 px-4 py-16">
				<div className="mx-auto max-w-6xl">
					<h2 className="mb-12 text-center text-3xl font-bold">Why Gust?</h2>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-4xl">
					<h2 className="mb-8 text-center text-3xl font-bold">Simple by Default</h2>
					<div className="overflow-hidden rounded-lg border bg-fd-card">
						<div className="flex items-center gap-2 border-b bg-fd-secondary/50 px-4 py-2">
							...
							<span className="ml-2 text-sm text-fd-muted-foreground">server.ts</span>
						</div>
...
// Using native Rust acceleration (220k+ req/s)`}</code>
			...
			<section className="border-t bg-fd-secondary/30 px-4 py-16">
				<div className="mx-auto max-w-6xl">
					<h2 className="mb-8 text-center text-3xl font-bold">Modular Architecture</h2>
